...
function binarySearchWrote7(nums, target) {
  let left = 0;
  let right = nums.length - 1;
...
function binarySearchWrote8(nums, target) {
  let left = 0;
  let right = nums.length - 1;
...
function binarySearchWrote9(nums, target) {
  let left = 0;
  let right = nums.length - 1;
...
function binarySearchWrote10(nums, target) {
  let left = 0;
  let right = nums.length - 1;
